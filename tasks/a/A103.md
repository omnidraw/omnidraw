...
- [x] Add authorized `vc_widget_preview_status`.
- [x] Add event-driven `vc_widget_preview_wait`.
- [x] Add the bounded declarative `vc_widget_preview_test` adapter.
- [x] Update the widget-authoring prompt and final-response contract.
- [x] Add authorization, race, cancellation, timeout, and interaction tests.
- [x] Add a widget-debug-tools black-box scenario.
...
- 2026-08-01: Implemented the authorized exact-preview status, event-driven
  wait, and bounded declarative test tools, including host fencing, prompt
  guidance, race/security regressions, and a passing public-tool black-box
  scenario.
