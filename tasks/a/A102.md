...
- [x] Replace the source manifest's private target with public API groups and
      partial budgets.
- [x] Migrate persisted editable source at one trusted boundary; keep old
...
- [x] Add the frozen `0.9.4` legacy-artifact acceptance fixture.
...
- 2026-07-30: Completed the repository-wide `0.10.0` public API-group cutover.
  The browser matrix passed 29 positive, negative, legacy, renderer, budget,
