...
- [ ] Extend the existing inspect tool with explicit artifact/preview modes.
- [ ] Add strict verification/fidelity/result schemas and pure validation.
- [ ] Resolve exact current Preview and accepted D10 generation safely.
- [ ] Reuse the real B84 manifest-bound Preview runtime/function bridge.
- [ ] Add build-required/pending/stale/import diagnostics.
- [ ] Make structured runtime/function/resource failures block success.
- [ ] Preserve safe authored locations and remediation through tool output.
- [ ] Fence cancellation, replacement, supersession, timeout, and shutdown.
- [ ] Update AI repair-loop prompts and tool documentation.
- [ ] Add causal protocol, generation, runtime, write, redaction, and repair tests.
- [ ] Capture real Preview and truthful artifact-mode browser evidence.
- [ ] Run focused/full/typecheck/build/lint/browser gates.
