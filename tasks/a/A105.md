...
- [ ] Add the runtime-backed canvas shell projection.
- [ ] Add centralized canvas-shell versus widget-shell ownership gating.
- [ ] Suppress all canvas overlays and projection interactions when maximized.
- [ ] Make maximized widgets implicitly content-interactive without focus mode.
- [ ] Restore clean contained frame state on exit and lifecycle invalidation.
- [ ] Add host, extension, Cangine integration, teardown, and AI Chat browser
      regressions.
- [ ] Refresh the maximized AI Chat entry in `SCREENS.md` if the verified state
      changes visibly.
