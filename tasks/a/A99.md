...
atlas, integrate Capsule's forthcoming public guest-runtime-location
...
- [ ] Adopt the released Capsule public `capsule-mount-error-v2`
      guest-runtime-location API.
- [ ] Add strict public-contract and package-boundary coverage.
- [ ] Bind startup and post-mount events to the exact Preview artifact,
...
- Capsule A24 owns generic sandbox runtime observation, not widget compilation
  or source-map mapping. The Capsule lane remains upstream-blocked until its new
  public API is implemented and released. Atlas verification, the reference
  fixture, latency sampling, and non-Capsule gates can proceed independently.
