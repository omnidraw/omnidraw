...
- [ ] Define a typed active-history item with an opaque Pi entry ID.
- [ ] Project canonical active history for connect and post-turn refresh.
- [ ] Add the typed chat edit-and-resend API operation.
- [ ] Implement serialized, no-summary Pi tree navigation and resend.
- [ ] Preserve original images and invalidate abandoned chat approvals.
- [ ] Add the inline yellow-box editor with accessible Cancel and Send actions.
- [ ] Reconcile optimistic and canonical history across streaming and failures.
- [ ] Add functional, service/API, UI, race, and no-rollback tests.
- [ ] Update the AI Chat screen atlas if the shipped interaction changes its
...
- No package version bump is required for planning-only task files.
