...
- [ ] Freeze the public offline-check and JSON/exit-code contracts.
- [ ] Choose/implement the public SDK or tooling package boundary.
- [ ] Extract/reuse portable pure manifest/source/contract validation.
- [ ] Add bounded safe project loading and widget-relative locations.
- [ ] Add strict CLI parsing, human output, and JSON output.
- [ ] Add check scripts/dependencies to plain and React scaffolds.
- [ ] Document offline check limitations and separate build/Preview inspection.
- [ ] Add external/no-host/no-db/no-network causal tests.
- [ ] Apply public package versions and regenerate lock/dist artifacts.
- [ ] Run focused/full/packed/typecheck/build/lint gates.
