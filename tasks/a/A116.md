...
- 2026-08-09: Recovered the upstream authoring-inspection implementation into
  committed Capsule source and merged it to Capsule `main` at `b2f5546` as
  `@omnidraw/capsule@0.14.0`. The clean reproducible package has npm integrity
  `sha512-yZLr2/O/Zwb2AAlIIXh0q0Opmjv3yue5HNahEkm6ajSLOAAeBN5iQkm/PGX9n2WR6T16iHK9F1pYpSR5Q8KHqA==`.
  Omnidraw now pins that version and integrity; its 39 adapter tests, managed
  browser acceptance, 22 package/release tests, and compiled signed action/PNG
  smoke pass against the installed registry package.
