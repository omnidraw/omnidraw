...
- [ ] Add the persisted three-mode approval policy and settings API.
- [ ] Add the AI Chat settings selector and reviewer-model selection.
- [ ] Remove approval expiry while preserving explicit lifecycle cancellation.
- [ ] Route automatic approval through the guarded execute-once path.
- [ ] Add the isolated structured AI reviewer with fail-closed fallback.
- [ ] Surface decision source and safe reviewer reason in events and UI.
- [ ] Add coordinator, API, settings, reconnect, UI, and security regressions.
