...
**Dropped:** the pilot architecture was superseded by the completed direct
Cangine and CanvasService cutover. Browser matrices and leak stress are not
required for that cutover. Any future widget-host qualification should be
planned from the current runtime rather than reviving this Automerge projection
pilot.
...
- 2026-07-28: Dropped after repository audit. Production already uses Cangine
  directly; the Automerge projection pilot and its multi-browser/leak gate are
  obsolete.
