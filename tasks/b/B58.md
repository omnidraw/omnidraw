...
- [ ] Define the per-mount serialization and coalescing contract.
- [ ] Serialize renderer updates and prevent stale completion from winning.
- [ ] Make renderer replacement and disposal safe with in-flight work.
- [ ] Add delayed-resolution, rejection, replacement, and disposal tests.
