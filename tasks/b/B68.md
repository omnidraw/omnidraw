# B68 - AI widget authoring: request and diagnose Capsule WebGL authority
[Overview](../BASED.md)
...
![Three.js widget passes construction validation but fails before Preview becomes ready](B68.png)
...
- [ ] Add the reported missing-profile/zero-budget regression fixtures.
- [ ] Make the supported Capsule capability catalog available to agent authoring.
- [ ] Add exact Three.js/WebGL authoring guidance and profile correction.
- [ ] Reject WebGL/WebGPU profiles with an effective zero GPU budget.
- [ ] Clarify construction-valid versus Preview-ready tool language.
- [ ] Preserve bounded actionable guest mount diagnostics in Preview and the lab.
- [ ] Add a positive Three.js r185 rendered-pixel browser acceptance test.
- [ ] Verify retained Preview construction remains publishable without rebuild.
- [ ] Run focused tests, typecheck, functional-core lint, and frontend build.
