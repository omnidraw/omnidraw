...
- [ ] Verify the exact fresh 14-table Turso schema and old-fingerprint rejection
- [ ] Run filesystem scan, integrity, path, collision, and restart tests
- [ ] Inject failure at every atomic publication transition
- [ ] Prove metadata-only byte identity and executable-change rebuilds
- [ ] Prove canvas remount preserves instance state and resource choices
- [ ] Run direct-function safety and no-history qualification
- [ ] Run cross-platform path/case coverage
- [ ] Rewrite architecture, widget-system, screen, and package documentation
- [ ] Regenerate `FILES.md` and run final repository checks
- [ ] Run build, typecheck, functional-core lint, package tests, and final acceptance
