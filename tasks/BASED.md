...
- [x]: [A126](a/A126.md) - canvas: Cangine 0.7 arrow head and tail connections
...
- [x]: [S140](s/S140.md) - widgets: lock one portable server ABI and two private host adapters (order 1/8)
- [x]: [S141](s/S141.md) - widgets: remove author-selected runtimes from the server contract (order 2/8)
- [x]: [S142](s/S142.md) - widgets: emit one host-neutral server module instead of a Bun envelope (order 3/8)
- [x]: [S143](s/S143.md) - functions: keep OSS execution direct, local, and trusted (order 4/8)
- [x]: [S144](s/S144.md) - resources: make function resource calls a portable SDK ABI (order 5/8)
...
- [x]: [S148](s/S148.md) - widgets: remove collaborative state and its APIs
