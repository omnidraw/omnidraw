...
- 2026-08-20: Split lightweight AI Chat frame metadata from its component and
  ...
  production semantic graph gate measured 414,960 gzip bytes across 16
...
- 2026-08-20: Verified Canvas typecheck and all 174 Canvas tests, component AI
  Chat typecheck and all 100 tests, frontend typecheck and production build.
  Bumped `@omnidraw/canvas` to 0.8.0 and `@omnidraw/component-ai-chat` to 0.2.0.
