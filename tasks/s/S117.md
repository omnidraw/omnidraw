...
- [ ] Delete ResourceOwnerLock implementation, fixture, tests, and exports
- [ ] Remove owner/root configuration from ResourceStoreService
- [ ] Remove CLI owner-ID construction and cross-process startup errors
- [ ] Remove `RESOURCE_OWNER_CONFLICT` from the resource error contract
- [ ] Preserve in-process lifecycle, drain, close, and retry behavior
- [ ] Rewrite ownership-oriented Store and CLI tests
- [ ] Remove ownership claims from resource-runtime documentation
- [ ] Remove the worktree owner-marker copy exclusion
- [ ] Update FILES.md and pass affected package/CLI checks
