...
- [ ] Create one shared, dynamically worded publication-confirmation flow.
- [ ] Add the Publish title action to draft Preview frames.
- [ ] Wire Preview publication to current draft/catalog state and expected revision.
- [ ] Replace direct draft-detail publication with the shared dialog.
- [ ] Refresh catalog, detail, Preview state, and published registration after success.
- [ ] Update the AI system prompt with the Preview/detail user-button boundary.
- [ ] Add focused confirmation, publication-result, title-action, and prompt tests.
- [ ] Run relevant tests, typechecks, functional-core checks, and frontend build.
- [ ] Update the screen atlas if implementation materially changes its Preview image.
