...
- 2026-07-30: S128 moved the canvas surface and grid from `engine.scene` to
  Cangine 0.5 retained projections. The reduction state now pairs only with
  the synthetic content layer and authored runtime nodes.
