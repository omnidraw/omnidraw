...
**Blocked on the published Cangine 0.5.0 release.**
...
- [ ] Confirm and qualify the released Cangine 0.5 projection API.
- [ ] Upgrade Cangine manifests and lockfile.
- [ ] Add one bottom-ordered canvas-background projection owner.
- [ ] Render the solid surface and grid as ordered owner-local nodes.
- [ ] Route theme and grid visibility directly to atomic owner replacement.
- [ ] Normalize the canvas background theme value to a Cangine color type.
- [ ] Remove the CSS canvas-surface background path.
- [ ] Remove runtime grid state and scene composition from
      `CanvasDocumentService`.
- [ ] Delete temporary runtime scene helpers and their bridge-only tests.
- [ ] Delete runtime background/grid IDs and validation from
      `canvas-contract`.
- [ ] Reconcile the independent projection revision with S127.
- [ ] Update `FILES.md`.
- [ ] Run focused tests, typechecks, builds, architecture checks, and browser
      QA.
