...
- [ ] Pin and hash the immutable engine release containing the accepted APIs.
- [ ] Verify the resource ADR, publication contract, portal boundary, and migration guidance.
- [ ] Add public-boundary consumer contract tests for all adopted guarantees.
- [ ] Replace application resource ownership with the engine registration owner.
- [ ] Remove resource readiness from durable scene commit success.
- [ ] Remove application last-good snapshot capture and restoration.
- [ ] Remove obsolete cross-system projection ownership staging.
- [ ] Audit portal integration and remove only behavior duplicated by the engine manager.
- [ ] Keep and serialize application-owned widget content updates; complete B58.
- [ ] Replace durable-to-preview reconstruction with `cloneFromScene`.
- [ ] Preserve product-to-transient conversion and product clone policy.
- [ ] Replace raw click bookkeeping with the opt-in recognizer; complete B56.
- [ ] Remove obsolete compatibility types, errors, tests, metrics, and exports.
