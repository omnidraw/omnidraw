...
function renderComposer(overrides: Partial<TChatComposerProps> = {}): TRenderedComposer {
  ...
  const root = container.querySelector<HTMLDivElement>(".ai-chat-tab--chat")
  const editor = container.querySelector<HTMLElement>(".ai-chat-composer__editor")
