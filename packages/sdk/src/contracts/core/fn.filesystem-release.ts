...
export function fnValidateWidgetRelease(args: Readonly<{
  ...
  if (
    ...
    || args.release.capsule.runtime.artifactHash !== args.release.capsule.artifactHash
  ) return { valid: false, reason: 'capsule_identity_mismatch' };
  if (!sameValue(
    fnNormalizeWidgetRuntimeDescriptor(args.release.capsule.runtime),
    fnNormalizeWidgetRuntimeDescriptor(args.observation.capsule.runtime),
