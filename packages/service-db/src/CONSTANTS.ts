export const DEFAULT_OSS_ORGANIZATION_ID = '00000000-0000-4000-8000-000000000001';
export const DEFAULT_OSS_ACCOUNT_ID = '00000000-0000-4000-8000-000000000002';
export const DEFAULT_OSS_CELL_ID = '00000000-0000-4000-8000-000000000003';
export const DEFAULT_OSS_ACCOUNT_DISPLAY_NAME = 'Local Owner';
export const DATABASE_APPLICATION_ID = 0x56494245;
export const DATABASE_JOURNAL_MODE = 'wal';
export const INITIAL_MIGRATION_VERSION = 0;
export const WIDGET_REVISION_SEQUENCE_MIGRATION_VERSION = 1;
export const FUNCTION_RUNTIME_MIGRATION_VERSION = 2;
export const AGENT_AUTHORING_MIGRATION_VERSION = 3;
export const LIVE_WIDGET_PREVIEW_MIGRATION_VERSION = 4;
export const CAPSULE_API_GROUPS_MIGRATION_VERSION = 5;
export const PREVIEW_SOURCE_MAPS_MIGRATION_VERSION = 6;
export const DATABASE_SCHEMA_VERSION = PREVIEW_SOURCE_MAPS_MIGRATION_VERSION;
export const INITIAL_MIGRATION_NAME = '000-initial.sql';
export const WIDGET_REVISION_SEQUENCE_MIGRATION_NAME = '001-widget-revision-sequence.sql';
export const FUNCTION_RUNTIME_MIGRATION_NAME = '002-function-runtime.sql';
export const AGENT_AUTHORING_MIGRATION_NAME = '003-agent-authoring.sql';
export const LIVE_WIDGET_PREVIEW_MIGRATION_NAME = '004-live-widget-preview.sql';
export const CAPSULE_API_GROUPS_MIGRATION_NAME = '005-capsule-api-groups.sql';
export const PREVIEW_SOURCE_MAPS_MIGRATION_NAME = '006-preview-source-maps.sql';
export const MIGRATION_CHECKSUM_ALGORITHM = 'sha256';
export const MIGRATION_CHECKSUM_HEX_LENGTH = 64;
export const MIGRATION_APPLICATION_VERSION_FALLBACK = '0.0.0';
export const DB_RESOURCE_DRAFT_LIST_DEFAULT_LIMIT = 50;
export const DB_RESOURCE_DRAFT_LIST_MAX_LIMIT = 200;
export const DB_RESOURCE_APPLY_LIST_DEFAULT_LIMIT = 20;
export const DB_RESOURCE_APPLY_LIST_MAX_LIMIT = 100;
