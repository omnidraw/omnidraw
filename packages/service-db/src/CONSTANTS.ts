...
export const WIDGET_INSTANCE_PROJECTION_MIGRATION_VERSION = 3;
export const AGENT_AUTHORING_MIGRATION_VERSION = 4;
export const DATABASE_SCHEMA_VERSION = AGENT_AUTHORING_MIGRATION_VERSION;
...
export const WIDGET_INSTANCE_PROJECTION_MIGRATION_NAME = '003-widget-instance-projection.sql';
export const AGENT_AUTHORING_MIGRATION_NAME = '004-agent-authoring.sql';
