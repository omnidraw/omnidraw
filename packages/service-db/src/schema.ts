import { sqliteTable, text, integer, real, blob, index, primaryKey, customType } from 'drizzle-orm/sqlite-core';
...
export type TAccountKind = 'user' | 'service_account' | 'system' | 'anonymous';
...
const accountKindDomain = customType<{ data: TAccountKind }>({
  dataType() {
    return 'account_kind';
  },
});
...
export const accounts = sqliteTable('accounts', {
  ...
  kind: accountKindDomain('kind').notNull().default('user'),
