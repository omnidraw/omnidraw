...
import { WIDGET_FRAME_MIN_HEIGHT, WIDGET_FRAME_MIN_WIDTH } from "@vibecanvas/service-actor/core/CONSTANTS"
...
export const WIDGET_HOST_MIN_WIDTH = WIDGET_FRAME_MIN_WIDTH
export const WIDGET_HOST_MIN_BODY_HEIGHT = 48
export const WIDGET_HOST_HEADER_HEIGHT = 28
export const WIDGET_HOST_MIN_HEIGHT = WIDGET_FRAME_MIN_HEIGHT
