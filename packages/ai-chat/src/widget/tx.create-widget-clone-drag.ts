...
import { VC_NODE_KIND_ATTR, VC_ON_REMOVE_ATTR } from "@vibecanvas/canvas/core/CONSTANTS";
import type { CrdtService, ElementService, HistoryService, RenderOrderService, SceneService, SelectionService } from "@vibecanvas/canvas/services";
