...
import { txSignOmnidrawCapsuleArtifact } from './tx.sign-capsule-artifact';
...
export class WidgetArtifactBuilderCapsule implements IWidgetArtifactConstructionBuilder {
  ...
  async signConstruction(
    ...
    const signed = await txSignOmnidrawCapsuleArtifact({
  ...
  }>): import('@omnidraw/widget-contract').TWidgetSourceMapArtifact | null {
