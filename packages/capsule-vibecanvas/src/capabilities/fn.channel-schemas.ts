...
export function fnVibecanvasWidgetPropsSchemaDocument(): CapsuleSchemaDocument {
  return {
    format: 'capsule-schema-v1',
    root: {
      type: 'object',
      properties: {},
      additionalProperties: fnVibecanvasBoundedJsonValueSchema(),
...
export function fnVibecanvasWidgetThemeSchemaDocument(): CapsuleSchemaDocument {
  const tokens = {
  ...
  return {
    ...
    root: {
      ...
      properties: {
        format: {
          type: 'literal',
          value: 'vibecanvas.widget-theme.v1',
        },
        appearance: {
          type: 'union',
          variants: [
...
export function fnVibecanvasWidgetOutputSchemaDocument(): CapsuleSchemaDocument {
  return {
    format: 'capsule-schema-v1',
    root: {
      type: 'object',
