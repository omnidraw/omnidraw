# Using the Capsule library — 0.10.2

This is the consumer manual for `@omnidraw/capsule`. Capsule 0.10.2 uses
...
The package version is `@omnidraw/capsule` 0.10.2. The group-contract format
