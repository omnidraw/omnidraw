...
| M3 — Tenant backend | `PASSED` | All backend authority surfaces and Automerge admission pass two-org isolation | [`m3-tenant-backend.md`](./baselines/m3-tenant-backend.md) |
