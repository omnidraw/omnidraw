...
The render-facing half of this vocabulary — the render entry points, the request event, `ResponseStub`, and the response-head primitives — is documented in [12 — SSR and the HTTP exchange](llm.12-ssr-http.md).
