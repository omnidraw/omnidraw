# Canvas-kernel external consumer fixture
...
`@omnidraw/service-theme`, and `@omnidraw/canvas`, copies this fixture into a
temporary directory, replaces only those three exact dependencies with the
