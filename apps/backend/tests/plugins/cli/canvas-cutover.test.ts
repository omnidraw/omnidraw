...
import { parseCanvasSubcommandArgs } from '../../../src/shell/cli/cmds/canvas-argv';
import { runCanvasAddCommand } from '../../../src/shell/cli/cmds/cmd.add.canvas';
import { runCanvasDeleteCommand } from '../../../src/shell/cli/cmds/cmd.delete.canvas';
import { runCanvasGroupCommand } from '../../../src/shell/cli/cmds/cmd.group.canvas';
import { runCanvasListCommand } from '../../../src/shell/cli/cmds/cmd.list.canvas';
import { runCanvasMoveCommand } from '../../../src/shell/cli/cmds/cmd.move.canvas';
import { runCanvasPatchCommand } from '../../../src/shell/cli/cmds/cmd.patch.canvas';
import { runCanvasQueryCommand } from '../../../src/shell/cli/cmds/cmd.query.canvas';
import { runCanvasReorderCommand } from '../../../src/shell/cli/cmds/cmd.reorder.canvas';
import { runCanvasUngroupCommand } from '../../../src/shell/cli/cmds/cmd.ungroup.canvas';
import type {
  ICanvasCliApi,
  TCanvasApiResult,
  TCanvasListEntry,
  TCanvasNode,
} from '../../../src/shell/cli/cmds/interface';
import { fnCanvasWebSocketUrl } from '../../../src/shell/cli/runtime/fn.canvas-websocket-url';
...
function canvasSnapshot(items: readonly TCanvasNode[]): TCanvasSnapshot {
  return {
    ...
    items: items.map((item, index) => ({
      ...
      createdAtSec: '2026-07-27 00:00:00',
      updatedAtSec: '2026-07-27 00:00:01',
    })),
  };
}
...
describe('canvas CLI A92 cutover', () => {
  ...
  test('targets the live local Effect RPC WebSocket endpoint', () => {
    expect(fnCanvasWebSocketUrl(7496)).toBe('ws://127.0.0.1:7496/rpc');
  });
});
