...
import type { IHumanResourceSecretService as IRuntimeHumanResourceSecretService } from '#backend/shell/resources';
import type { resourceContract } from './contract';

type TResourceInputs = InferProcedureRouterInputs<typeof resourceContract>;
type TResourceOutputs = InferProcedureRouterOutputs<typeof resourceContract>;
