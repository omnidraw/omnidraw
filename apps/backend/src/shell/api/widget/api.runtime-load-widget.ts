...
function runtimeTargetNotFound(): ProcedureError<'NOT_FOUND', unknown> {
  return new ProcedureError('NOT_FOUND', {
    message: 'Published widget is missing or unhealthy.',
  });
}

function runtimeOperationFailed(): ProcedureError<'INTERNAL_SERVER_ERROR', unknown> {
  return new ProcedureError('INTERNAL_SERVER_ERROR', {
