import type {
  InferProcedureRouterInputs,
  InferProcedureRouterOutputs,
} from '../procedure';
...
type TAgentInputs = InferProcedureRouterInputs<typeof agentContract>;
type TAgentOutputs = InferProcedureRouterOutputs<typeof agentContract>;
...
export type TAgentApiCapability = {
  ...
  ): Promise<TAgentOutputs['chat']['history']>;
  promptChat(
...
export type TAgentEventCapability = {
  ...
  ): AsyncIterable<TSequencedEvent<TAgentEvent>>;
};
