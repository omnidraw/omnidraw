...
export type TWidgetCatalogFilesystemEffects = Readonly<{
...
export type TWidgetCatalogHashEffects = Readonly<{
...
export type TWidgetCatalogCapsuleInspectionEffects = Readonly<{
...
export type TWidgetCatalogContractEffects = Readonly<{
...
export type TWidgetCatalogScanEffects = Readonly<{
  filesystem: TWidgetCatalogFilesystemEffects;
  hash: TWidgetCatalogHashEffects;
  capsule: TWidgetCatalogCapsuleInspectionEffects;
  contracts: TWidgetCatalogContractEffects;
}>;
