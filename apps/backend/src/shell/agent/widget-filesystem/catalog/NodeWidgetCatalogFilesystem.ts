...
import type {
  ...
  TWidgetCatalogFilesystemEffects,
  TWidgetCatalogHashEffects,
} from './typed';
...
export class NodeWidgetCatalogFilesystem implements TWidgetCatalogFilesystemEffects {
...
export class NodeWidgetCatalogHash implements TWidgetCatalogHashEffects {
