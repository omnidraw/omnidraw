...
export const OMNIDRAW_CAPSULE_PREVIEW_SIGNING_KEY_ID = 'omnidraw-preview-v1';
export const OMNIDRAW_CAPSULE_RELEASE_SIGNING_KEY_ID = 'omnidraw-release-v1';
export const OMNIDRAW_CAPSULE_TESTED_THREE_VERSION = '0.185.1';
...
export const OMNIDRAW_CAPSULE_LIMITS = Object.freeze({
  gpuBytes: 64 * 1024 * 1024,
}) satisfies CapsuleBudgetRequest;

/** Host groups use Capsule's own defaults unless Omnidraw measures a need to narrow them. */
export const OMNIDRAW_CAPSULE_HOST_LIMITS = Object.freeze(
  {},
) satisfies CapsuleBudgetRequest;

export const OMNIDRAW_CAPSULE_API_CONTRACT_FORMAT =
  CAPSULE_API_GROUP_CONTRACT_FORMAT;
export const OMNIDRAW_CAPSULE_API_BUNDLE_DIGEST =
  CAPSULE_API_GROUP_BUNDLE_DIGEST;

/** Snapshot parking remains denied for the first Capsule release. */
export const OMNIDRAW_CAPSULE_PARKABILITY = Object.freeze({
  parkable: false,
