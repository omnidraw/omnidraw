...
} from '#backend/shell/widget-runtime/capabilities/fn.capability';
import {
...
} from '#backend/shell/widget-runtime/capabilities/fn.json-schema';
import {
  fnOmnidrawWidgetOutputSchemaDocument,
  fnOmnidrawWidgetPropsSchemaDocument,
  fnOmnidrawWidgetThemeSchemaDocument,
} from '#backend/shell/widget-runtime/capabilities/fn.channel-schemas';
import type {
  TOmnidrawCapsuleCapabilityContract,
  TOmnidrawCapsuleChannelContract,
} from '#backend/shell/widget-runtime/capabilities/types';
