...
implements TWidgetCatalogCapsuleInspectionPortal {
  constructor(
  ...
  async inspectCapsuleArtifact(
    args: Parameters<TWidgetCatalogCapsuleInspectionPortal['inspectCapsuleArtifact']>[0],
  ): Promise<Awaited<ReturnType<TWidgetCatalogCapsuleInspectionPortal['inspectCapsuleArtifact']>>> {
